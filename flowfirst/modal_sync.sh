...
#     flowfirst/modal_sync.sh            # everything on the volume
#     flowfirst/modal_sync.sh <run-dir>  # one run directory only, e.g. flowfirst-gnn-20node-x8-b128-gnn128r6ln-step-clip-ema-b200
cd "$(dirname "$0")/.."
remote="/${1:-}"
while true; do
